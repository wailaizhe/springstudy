...
public class MyPageInterceptor implements Interceptor {private Integer defaultPage;//默认页码
...
private int getTotal(Invocation ivt, MetaObject metaStatementHandler, BoundSql boundSql) throws SQLException {
    ...
    try {
        ...
        System.out.println("查询总数的sql:"+boundSql);
